...
import { useDb, currentUser, logout, notificationsFor, markAllNotificationsRead, tripById, joinViaInvite } from './store/store'
import { Avatar, BrandMark, ToastZone, useClickOutside } from './components/ui'
...
export default function App() {
  ...
  // route shapes: /, /auth, /trips, /new, /trip/:id, /explore, /pub/:slug, /invite/:tripId, /profile
