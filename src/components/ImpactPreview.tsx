...
export function ImpactPreviewPanel({ result, onKeep, onMoveDay, onRemove }: {
  result: ImpactResult
  trip?: Trip
  onKeep: () => void
  onMoveDay: () => void
  ...
  return (
    <div className="impact-panel" role="status">
      ...
      <div className="impact-body">
        ...
        <div className="impact-actions">
          <button className="btn btn-primary btn-sm" onClick={onKeep}>Keep change</button>
