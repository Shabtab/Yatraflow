...
- **Fuel-accurate costs** — car/bike trips can state a fuel economy (km/L, at creation or in trip settings); legs are then priced as `distance ÷ economy × ₹105/L` (indicative petrol price, surfaced on screen) instead of a blended ₹/km rate
